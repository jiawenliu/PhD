\begin{example}[twoRounds]
   ...
   % these query nodes are defined as adaptivity.
   %
   ...
   {{ $l^6: {}^{w_1}_{1}$}};
   % Counter Variables
   \draw[] (6, 9) circle (0pt) node {\textbf{$j^1: {}^{w_1}_{0}$}};
   \draw[] (6, 6) circle (0pt) node {{ $j^4: {}^{w_k}_{0}$}};
   %
   ...
   {{ $l^6: {}^{1}_{1}$}};
   % Counter Variables
   \draw[] (5.5, 9) circle (0pt) node {\textbf{$j^1: {}^{1}_{0}$}};
   \draw[] (5.5, 6) circle (0pt) node {{ $j^4: {}^{k}_{0}$}};
   %
   % Value Dependency Edges:
   \draw[ ultra thick, -latex, densely dotted, blue] (0, 1.5) -- (0, 3.5) ;
   \draw[ ultra thick, -latex, densely dotted, blue] (0, 4.5) -- (0, 6.5) ;
   ...
   \draw[ thick, -latex] (0, 7.5) -- (0, 9.5) ;
   \draw[ thick, -Straight Barb] (1.5, 3.5) arc (120:-200:1);
   \draw[ thick, -Straight Barb] (7, 6.5) arc (150:-150:1);
   \draw[ thick, -latex] (5.5, 6.5) -- (5.5, 8.5) ;
   % Control Dependency
   \draw[ thick,-latex] (1.5, 7) -- (4, 9) ;
   \draw[ thick,-latex] (1.5, 4) -- (4, 9) ;
   \draw[ thick,-latex] (1.5, 7) -- (4, 6) ;
