...
It is presented in \todo{Thesis~\cite{}}.
\subsection*{Syntax}
...
Figure~\ref{fig:evaluation} is a selection of rules of their trace-based operational semantics from \todo{Thesis~\cite{} citation}.
...
\begin{itemize}
  ...
  In the rule \rname{l-loop}, a nature number $v_N$ is required on the premise tracking the iteration times.
