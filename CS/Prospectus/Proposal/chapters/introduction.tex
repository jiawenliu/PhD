...
% to the worst case cost analysis in a traditional way.
 ...
 Finally, the Section~\ref*{subsec:intro-cfl} introduce 
...
developed w.r.t. the three problems as follows.
...
% property of programs. This analysis is developed 
 in three steps through different methodologies as follows,
 \begin{enumerate}
...
I plan to focus on the following three further features can be extended and improved in my full-spectrum analysis.
\begin{enumerate}
    \item Extension of the {\tt Query While} Language with inter-procedure call.
    \item In the execution-based \emph{adaptivity},
    I plan to improve the precision of formalizing the intuitive \emph{adaptivity},
%  in the formal  model 
