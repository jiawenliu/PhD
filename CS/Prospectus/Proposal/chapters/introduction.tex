...
\item Three proposed further features to be improved based on the 
% formal adaptivity model and {\THESYSTEM}, 
 full-spectrum adaptivity analysis presented in Section~\ref{sec:language},~\ref{sec:dynamic} and~\ref{sec:static},
