...
of the program analysis framework for adaptivity,
...
developing a  path sensitive reachability bound analysis technique. 
...
\end{enumerate}
\subsubsection{Towards Accurate Program Quantitative Property Analysis}
