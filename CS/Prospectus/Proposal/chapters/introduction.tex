...
% % 
I first introduce the Motivation of reasoning about the adaptivity quantity property for adaptive data analysis programs in Section~\ref{subsec:intro-motivation}.
Then, I introduce the problems encountered when analyzing this \emph{adaptivity} property for the adaptive data analysis programs in Section~\ref{subsec:intro-adapt}
...
% to the worst case cost analysis in a traditional way.
 ...
 Finally, the Section~\ref*{subsec:intro-cfl} introduced the interest in showing that
...
I will focus on improving three features of this full-spectrum analysis as follows,
\begin{enumerate}
...
\end{enumerate}
\subsubsection{Towards Accurate Program Resource Cost Analysis and Methodology}
