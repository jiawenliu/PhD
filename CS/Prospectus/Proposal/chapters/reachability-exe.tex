...
% assigned variables and labeled variables 
...
\end{defn}
%
% Every label and every labeled command in a program are unique, formally as follows with proof in Appendix~\ref{apdx:lemma_sec123}.
...
When the program executes under an initial trace $\trace_0$,
