...
% \\
    ...
    % \\
    \highlight{
        This variable estimation method is low-efficient, especially for the while loop. Specifically in rule \textbf{ag-loop} as in Figrue~\ref{fig:prework-static_alg1},
...
The rule \textbf{ad-loop} is as low-efficient and expressiveness-limited as the rule \textbf{ag-loop}
%  in Figure~\ref{fig:prework-static_alg1} 
for the same reason.
