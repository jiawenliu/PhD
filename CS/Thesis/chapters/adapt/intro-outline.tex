...
The rest chapters in this part are organized as follows. 
\begin{enumerate}
   \item The previous works on analyzing the \emph{adaptivity} of adaptive data analysis are introduced in Section~\ref{sec:prework}.
   
   \item The new program analysis framework for \emph{adaptivity} in adaptive data analysis with three components.
   \begin{enumerate}
      \item A while-like language extended with query requesting feature, named {\tt QWhile} Language, 
   ...
   \end{enumerate}
   \item Examples demonstrating our program adaptivity analysis framework,
...
This part has the following contributions.
\begin{enumerate}
   ...
   \item A soundness proof of the program analysis showing that the adaptivity estimated by {\THESYSTEM} bounds the \emph{adaptivity} of the program given by the formal definition. 
