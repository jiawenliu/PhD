...
Symbolic expressions as used in the weight are great to express symbolic upper bounds, but make the computation of 
...
\begin{algorithm}
 ...
 Then, 
 we compute a local bound for the adaptivity of every $\kw{\sccgraph_i}$
