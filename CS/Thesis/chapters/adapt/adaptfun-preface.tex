...
\begin{itemize}
   ...
   \item The Section~\ref{sec:alg_weightgen} analyzes the \emph{quantitative} sub-property
   ...
   \item Then Section~\ref{sec:alg_graphgen} constructs the \emph{estimated dependency graph} encoding two estimated results above, together with the statically collected vertices and query annotation.
   \end{enumerate}
