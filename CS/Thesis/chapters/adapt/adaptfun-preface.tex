...
\begin{itemize}
 ...
 \begin{enumerate}
 \item In Section~\ref{sec:alg_edgegen}, I first analyze the \emph{reachability} sub-property
 % --
 ...
 \item In Section~\ref{sec:alg_weightgen}, I analyze the \emph{quantitative} sub-property
 ...
 \item Then in Section~\ref{sec:alg_graphgen}, I construct the \emph{estimated dependency graph} encoding two estimated results above, together with the statically collected vertices and query annotations.
 \end{enumerate}
