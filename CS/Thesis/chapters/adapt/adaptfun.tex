...
\cite{SinnZV17}. For concise, I use $\dcdom^{\top}$ to represent the $DC(\mathcal{VAR}  \cup \constdom) \cup \{\top\}$ .
...
% % an expression abstraction method based on the expression abstraction in paper \cite{SinnZV17}.
% \\
...
This is the same as in paper \cite{SinnZV17}. 
\\
...
\end{array}
  ...
  The second and third step is guaranteed by the \emph{Discussion on Soundness} in Section 4 of \cite{SinnZV17}.
