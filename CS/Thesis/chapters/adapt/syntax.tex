...
\\
%
{\mathcal{T}} & : & \mbox{Universe of Traces}
\\
%
...
\\
\mathcal{T}_0(c) & : & \mbox{Set of Program $c$'s Well-formed Initial Traces.}
\\ & & \mbox{Each well formed initial trace $\trace_0 \in \mathcal{T}_0(c)$ is finite and every input variable of the program $c$ has an initial value in $\trace_0$.}
\end{array}
\]
%
Expressions include
