...
\]
%
Expressions include extended arithmetic expression $\aexpr$ with value $n \in \mathbb{N}\cup \{\infty\}$ and $\emax$, $\emin$, $\elog$ and $\esign$ operators;
...
A boolean expression can be either {\tt true} or {\tt false}, basic boolean connectives between boolean expressions including logical negation, logical and or denoted by $\oplus_b$, and basic comparison $sym$ between arithmetic expressions, e.g., $\leq,=,<,$, etc.
