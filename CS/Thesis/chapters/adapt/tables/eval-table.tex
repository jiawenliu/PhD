...
{\scriptsize
        ...
        %  $  \kw{ifVD()}$ & $3$ & $3$ &  $3$ & 5 & 0.0010 & 0.0005  & 0.0001 \\
         ...
         $  \kw{loop(k)}$ & $1+\frac{k}{2}$ &   $1 +\max(1, \frac{k}{2})  $  &  $1+\frac{k}{2}  $ & 7 & 0.0021 & 0.0015 &  0.0001 \\
         ...
         {$ \kw{loopMP(k)}$} & $1 + k$ &  $ 2 + \max(1,2k) $ & $1 + 3k  $  &  9 & 0.0017 & 0.0062  & 0.0001  \\
         {$ \kw{loop2MP(k)}$} & $1 + k$ &  $ 2 + k $ & $1 + 3k  $  &  9 & 0.0017 & 0.0062  & 0.0001  \\
         { $\kw{loop2RV(k)}$} & $1 + 3k$ &  $1 + 3k $ &  $1 + 3k  + k^2$  &  11 & 0.019 & 0.2669  & 0.0007 \\
         $  \kw{mRCom(k,c,N)}$ & $k$ & $ k   $ & $k $   &  27 & 0.0026 & 85.9017  & 0.0004 \\
         $  \kw{mRCop(k)}$ & $2k$ & $  2k $ & $ 2k $   &  46 & 0.0036 & 5104  &  0.0013\\
