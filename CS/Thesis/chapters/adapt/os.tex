...
$ \pi_i : 
\eventset \to \mathcal{V} \cup \booldom \cup \mathcal{L} \cup \mathcal{VAL} \cup \mathcal{QVAL} \cup\{\bullet\} $.
...
In this sense, we 
define the equivalence of query expressions by comparing their query value(i.e., the normal form query request) and quantifying over all possible values of the hidden the database.
