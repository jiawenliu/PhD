...
In the rest part of this work, we rule out this situation and consider finite trace as well-formed only when the program terminates.
\\
...
\begin{defn}[Non-terminating and Infinite Trace]
  ...
  \]
\end{defn}
In the rest part of this work, we consider as well-formed only the terminating execution and finite trace.
