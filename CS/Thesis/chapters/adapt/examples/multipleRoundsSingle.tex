\begin{example}[Single Adaptivity Round Example]
    ...
    Weight of this vertex is $\lambda \trace_0 \sthat \env(\trace_0) k$,
    % The function $\lambda \trace_0 \sthat \env(\trace_0) k$ 
    ...
    is $\lambda \trace_0 \sthat \env(\trace_0) k + 2$, instead of $\max\{0, 2, 3\}$. 
