\begin{figure}
    ...
    \draw[ thick, -latex, densely dotted,] (0, 4.2)  -- (0, 6.5) ;
    \draw[ thick, -Straight Barb, densely dotted,] (2, 4.5) arc (150:-180:1);
    ...
    \caption{}
     ...
     \caption{(a) The k adaptivity rounds example with simple while loop (b).
      The estimated dependency graph by $\THESYSTEM$.}
