...
\begin{example}[The Two Rounds Analyst Strategy]
...
\begin{algorithm}
    ...
    %
%
We also have the complete implementation of the algorithm above in our language below, which is evaluated in the first line in Table~\ref{tb:adapt-imp}.
\[
...
\]
%
The evaluation result in the $1^{st}$ line in Table~\ref{tb:adapt-imp} shows that our {\THESYSTEM} works well for this complete implementation.
    \end{example}