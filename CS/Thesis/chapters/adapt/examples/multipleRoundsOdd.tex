\begin{example}
    ...
    \centering
    {
     ...
     \clabel{\assign{x}{\query(\chi(\elog y))} }^{7} \Big)
     \end{array}
     \]
    }
     \caption{}
    ...
    \begin{subfigure}{.5\textwidth}
     \begin{centering}
     \begin{tikzpicture}[scale=\textwidth/10cm,samples=250]
    % Variables Initialization
    \draw[] (5, 1) circle (0pt) node{{ $x^1: {}^{\lambda \trace_0. 1}_{1}$}};
    % Variables Inside the Loop
     \draw[] (0, 7) circle (0pt) node{{ $y^5: {}^{\lambda \trace_0. \env(\trace_0) \frac{k}{2}}_{1}$}};
     \draw[] (0, 4) circle (0pt) node{{ $p^6: {}^{\lambda \trace_0. \env(\trace_0) \frac{k}{2}}_{1}$}};
     \draw[] (0, 1) circle (0pt) node{{ $x^7: {}^{\lambda \trace_0. \env(\trace_0) k}_{1}$}};
     % Counter Variables
     \draw[] (5, 7) circle (0pt) node {{$j^0: {}^{\lambda \trace_0. 1}_{0}$}};
     \draw[] (5, 4) circle (0pt) node {{ $j^3: {}^{\lambda \trace_0. \env(\trace_0) k}_{0}$}};
     %
    ...
    % Edges produced by the transitivity
    ...
    \draw[ -latex ] (1.2, 1.0) arc (120:-200:1);
     ...
     \end{subfigure}
     \vspace{-0.4cm}
    \caption{(a) The multiple-path loop program with multiple adaptivity rounds. 
