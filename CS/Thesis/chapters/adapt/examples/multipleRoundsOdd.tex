...
\begin{subfigure}{.6\textwidth}
    \begin{centering}
    \begin{tikzpicture}[scale=\textwidth/10cm,samples=300]
% Variables Initialization
\draw[] (5, 1) circle (0pt) node{{ $x^1: {}^{\lambda \trace_0. 1}_{1}$}};
% Variables Inside the Loop
 \draw[] (0, 7) circle (0pt) node{\textcolor{blue}{ $y^5: {}^{\lambda \trace_0. \env(\trace_0) \frac{k}{2}}_{1}$}};
 \draw[] (0, 4) circle (0pt) node{\textcolor{blue}{ $p^6: {}^{\lambda \trace_0. \env(\trace_0) \frac{k}{2}}_{1}$}};
...
\end{tikzpicture}
 \caption{}
    ...
    % Variables Inside the Loop
     \draw[] (0, 7) circle (0pt) node{\textcolor{blue}{ ${y^5: {}^{k}_{1}}$}};
     \draw[] (0, 4) circle (0pt) node{\textcolor{blue}{ ${p^6: {}^{k}_{1}}$}};
