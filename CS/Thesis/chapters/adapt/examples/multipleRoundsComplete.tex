    ...
    %     \end{subfigure}
    %     \vspace{-0.3cm}
        \caption{The labeled program implementing the multiple round algorithm.}
        \vspace{-0.5cm}
        \label{fig:multiround_complete}
        \end{figure}
    }
    The evaluation table in Table~\ref{tb:adapt-imp} shows that our {\THESYSTEM} works well for this complete implementation.
    %
    \end{example}