...
In this Chapter, based on the language and the trace-based operational semantics in Chapter~\ref{sec:language},
...
Section~\ref{sec:dynamic-datadep}, Section~\ref{sec:dynamic-reachability} and ~\ref{sec:dynamic-adapt}.
