...
In order to define the \emph{may-dependency} relation, we need to be able to obeserve the difference of variable
on traces, i.e., the events contained in traces.
...
\highlight{
    ...
    % \\
\highlight{Also, this externalization of two witness traces helps in analyzing the dependency quantity through the same 
