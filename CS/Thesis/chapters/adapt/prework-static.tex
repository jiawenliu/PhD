...
loop language-based definition. The complete definition is in \todo{Thesis}.
%
...
The rule \textbf{ad-loop} is still as low-efficient and expressiveness-limited as the rule \textbf{ag-loop} in Figure~\ref{fig:prework-static_ag1} for the same reason.
