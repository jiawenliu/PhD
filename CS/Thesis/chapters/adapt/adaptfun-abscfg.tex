...
\begin{defn}[Constraint Computation]
  ...
  \footnote{We omit the input $c$ here as well as in the rest of \redd{PART \romannum{1}} because the context is clear. In \redd{PART \romannum{2}},
  we will distinguish the input program $c$ explicitly in the input.}
