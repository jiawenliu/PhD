...
% \subsection{More Discussions on The Evaluated Examples} 
 ...
 The first one is the two rounds adaptivity data analysis which we present as the walk-through example.
 The second one is the complete multiple rounds adaptive data analysis for the simplified version that we discussed in Example~\ref{ex:multipleRounds}.
