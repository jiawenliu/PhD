...
Following this intuition, we need to formally define
...
we summarize them into three sub-research motivation as follows.
% Most techniques that are used to define these relations, or used in previous work have different limitations. We summarize these techniques and their limitations as follows.

% \paragraph{Technique Limitations in Existing Method}
% There are many techniques for analyzing a program's execution or formalizing program's semantics properties, including program simulation, 
...
% There are following three limitations among existing semantics-based formalization methodologies.
...
We summarize them as three sub-research motivations as follows.
