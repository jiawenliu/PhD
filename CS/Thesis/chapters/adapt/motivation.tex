...
% \\
%
\subsection{Technical Limitation}
...
\item From the \emph{quantitative} perspective, the state-of-art data dependency relation formalization, there isn't any technique taking into account
...
from \emph{reachability} and \emph{quantitative} perspectives as well in 

We summarize it as three sub-goals below. Each of them aims to resolve a fact introduced in the \textbf{Adaptivity Estimation} challenge in Section~\ref{sec:adapt-motivation}.
\\
