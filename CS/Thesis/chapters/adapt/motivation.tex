...
This is the reason we claim that the \emph{adaptivity} of a program is a specific of
the \emph{quantitative-reachability} property.

As we discussed in Section~\ref{sec:intro-methodology-adapt-formalization}, existing formalization methodology cannot
