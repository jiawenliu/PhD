...
However, these language designs are largely limited in their expressiveness.
Most of the general data analyses are not supported by the previous language design.
In Section~\ref{sec:prework-language}, we introduce in detail the previous language design and limitations.
