...
As we discussed in Section~\ref{sec:intro-methodology-adapt-language}, the existing language mainly focuses on efficiency and scalability of the programs.
They are not able to model the query and mechanisms in the way that allow
us to analyze the \emph{rounds of adaptivity}
...
As we discussed in Section~\ref{sec:intro-methodology-adapt-formalization}, existing formalization methodologies cannot
capture the two sub-properties of the \emph{adaptivity}.
...
We also discussed in Section~\ref{sec:intro-methodology-adapt-formalization}, most existing techniques are limited
in analyzing the \emph{adaptivity}.
