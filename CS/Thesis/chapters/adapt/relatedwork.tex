\section{The Formalization Methods}
\label{sec:relatedwork-adapt-semantics}
Our adaptivity analysis framework constructs a semantics-based dependency graph based on the execution traces of a program. 
