...
DDGs have been used in many other domains. For example,~\citet{NagarJ18} use DDGs to find serializability violations. \citet{HammerGK06} proposes similar ways of constructing different kinds of program slices based on the algorithm presented in~\cite{ferrante1987program}, by choose different program dependency graph.
