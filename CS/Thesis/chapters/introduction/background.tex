...
we study the program's \emph{reachability-bound} in order to improve the efficiency of the program executed on mobile device and guarantee high-quality service in people's daily life.
