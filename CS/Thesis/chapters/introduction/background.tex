...
by the \emph{adaptivity rounds} property. It is a \emph{quantitative-reachability} property of the data analysis programs, which captures both the data dependent as the reachability perspective and the dependent times as the quantitative perspective.
...
This motivates us to look into the program's \emph{reachability-bound} for every program location.
