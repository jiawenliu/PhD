...
Then, these generalized results are used to recommend games, musics, clothes, and etc. to arbitrary
users who might come from the unknown population.
...
Under the light of existing machine learning studies, some researches found that certain non-functional properties of data analysis algorithms can help to control the generalization error, especially when the data analysis is adaptive.
\\
...
We are interested in analyzing it as a \emph{quantitative-reachability} property using the principles of programming languages to help reduce the generalization error of corresponding algorithm.
...
We observe that both of the performance and privacy
can
%  of
...
i.e., whether certain piece of code is executed (the \emph{reachability}) and how many times it is executed  (the \emph{quantitative}).
...
To this sense, analyzing and controlling it from two perspectives can better help to improve program reliability, security, privacy, usability, etc., and then guarantee the
% high-quality
% service through the 
\emph{efficiency} and \emph{privacy} in people's daily life when they use the
mobile applications.
%  people experience.
% 's life than just from single view. 
