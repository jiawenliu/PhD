...
Based on the formalization of these \emph{quantitative-reachability} properties,
% and  static program analysis techniques in different research lines,
we develop new static program analysis frameworks to best exploit the benefit of these properties in data analysis and resource usage. 
