...
\todo{Shorten}
As a natural continuation, we want to improve the precision in analyzing  the \emph{adaptivity rounds} and 
the efficiency of the program executed on mobile device and guarantee high-quality service in people's daily life.
