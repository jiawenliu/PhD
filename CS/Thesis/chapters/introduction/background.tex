...
We notice that people's daily life
...
Studies found that some non-functional properties of data analysis programs can help to control the generalization error, especially when the data analysis is adaptive.
\\
These non-functional program properties can be expressed from two perspectives, the \emph{quantitative} and \emph{reachability}.
...
\\
This property can also be expressed from two perspectives, whether certain piece of code is executed (the \emph{reachability}) and how many times it is executed  (the \emph{quantitative}).
...
We first formalize these conceptual \emph{quantitative-reachability} properties through specific programming language models.
% and  static program analysis techniques in different research lines,
