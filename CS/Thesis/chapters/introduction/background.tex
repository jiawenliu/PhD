...
Under the light of existing machine learning studies, some researches found that some non-functional properties of data analysis algorithms can help to control the generalization error, especially when the data analysis is adaptive.
\\
