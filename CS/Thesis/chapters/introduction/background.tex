...
we choose to study the non-functional properties, specifically quantitative reachability properties.
...
Some program properties mentioned above can be expressed in the form of reachability,
such as
...
This requires extra analysis
of the program's quantitative property. 
To this end, this thesis focus on analyzing the program's quantitative reachability. 
...
In this thesis, we analyze two quantitative reachability properties of programs that can be used to improve programs' performance.

As the first properties, we want to improve the data analysis results and reduce its generalization error.
%  High generalization error makes the analysis result of these programs not reliable.
...
These properties are the first kind quantitative reachability properties we are interested in
analyzing.

\highlight{
As the second quantitative reachability property
we look at the program's reachability-bound.
...
we develop new program analysis frameworks to best exploit the benefit of these quantitative reachability properties in data analysis and resource usage. However, to fully utilize the aforementioned benefits of the new analysis frameworks on these non-functional properties, the appropriate implementation is inevitable. 
...
Last but not least, these quantitative reachability properties are not limited to static analysis. 
