...
Because of its nature as a reachability quantitative property, it requires us to defining both the dependency property and the quantitative property for the program.
