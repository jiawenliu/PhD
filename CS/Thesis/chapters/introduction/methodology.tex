...
Although many static program analysis techniques and algorithms in graph theory can be repurposed here, such as control flow analysis, resource cost analysis,
data dependency estimation, path-search algorithms, etc.,
...
\paragraph{Our Method.}
Our new method is a light-weight path refinement algorithm adapted from~\cite{GulwaniJK09}.
We compute the refined program based on the abstract transition graph and then
