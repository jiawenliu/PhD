\begin{example}
  ...
  \[
    ...
    $\lpchB(1: \rprog_1^1, \tpath_5) = \frac{n}{4}$ \\ 
    {$\lpchB(1: \rprog_1^1, \tpath_2) = \frac{n}{4}$} \quad
    $\lpchB(1: \rprog_1^2, \tpath_1) = \frac{n}{4}$ \quad
    $\lpchB(1: \rprog_1^2, \tpath_3) = \frac{n}{4}$ \\ 
    $\lpchB(1: \rprog_1^2, \tpath_5) = \frac{n}{4}$ \quad 
    \highlight{$\lpchB(1: \rprog_1^2, \tpath_2) = \frac{n}{4}$} \quad
