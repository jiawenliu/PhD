...
(c) The corresponding simple transition paths.}
    \label{fig:whileTwoCounters-overview}
\end{figure}
}
\footnotetext{We use the notation $(l_0 \to \ldots \to l_n)$ to denote a path with vertices sequence $(l_0, \ldots, l_n)$, and the constraint on each edge is omitted for concise.}
