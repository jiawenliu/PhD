...
during the execution of loop $L_1$, the algorithm in Section~\ref{sec:psRB-looprb} computes a tight \emph{loop reachability-bound}, $\lpchB(\rprog_1^1, \tpath_3, c) = 1$. 
...
% So 
Section~\ref{sec:psRB-pathrb} computes the  \emph{path reachability-bound} 
