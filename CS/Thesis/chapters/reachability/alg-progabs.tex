...
is computed as follows in Definition~\ref{def:absevent_compute}.
 ...
 We compute the \emph{abstract execution trace}, $\absflow(c) \in \mathcal{P}( \ldom \times \dcdom^{\top} \times \ldom )$ of a program $c$ is computed as follows.
...
Then, we compute the $\absflow(c) = \absflow'(c')$ for $c'$ as follows,
 ...
 \\ & \quad 
 \cup \{(l, \absexpr(\bexpr, \top, c), \absinit(c_w)) \} 
 \\ & \quad 
...
loop $\ewhile \clabel{i > 0}^1 \edo \{\ldots\}$ will be executed next.
