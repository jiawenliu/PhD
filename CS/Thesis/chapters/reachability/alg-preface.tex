...
\item In the same time of refining the program, we also compute the \emph{Ranking Function} in Section~\ref{sec:psRB-rank}\footnote{\textbf{ranking function} is the named used in \cite{SinnZV14}
