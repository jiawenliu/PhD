...
% \begin{enumerate}
 \item Section~\ref{sec:psRB-pathlocalrb} gives the computation of the first quantity -- the local \emph{path reachability-bound}, $\outinB(\rprog, \tpath)$ for every \emph{simple transition path} $\tpath$ in Section~\ref{sec:psRB-pathlocalrb}. 
