...
Section~\ref{sec:psRB-psrb} defines the quantities that are needed to be computed in this algorithm and the following sections describe the computations of each quantity. 
% \begin{enumerate}
