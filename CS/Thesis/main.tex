...
\chapter{The {\tt Query While} Language}
\label{ch:language}
...
\chapter{Static Path-Sensitive Reachability Bound Analysis}
\label{ch:pathsensitive_rb}
\clearpage

\chapter{The Program Analysis Framework Improvement}
\label{ch:improved}
\include{chapters/improved}
% \clearpage

% \addtocontents{toc}{\protect\newpage}
\chapter{Future Work on Accurate Program Non-Monotonic Resource Cost Analysis via {\THESYSTEM}}
\label{ch:generalization}
\input{chapters/generalization}

% \chapter{Accurate Program Non-Linear quantitative Property Analysis via {\THESYSTEM}}
% \label{ch:generalization}
% \input{chapters/generalization}
