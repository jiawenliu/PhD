...
\subsection{Algorithm Guideline}
\label{sec:static-overview}
\input{chapters/adapt/adaptfun-guide}

\subsection{Graph Vertex and Annotation Estimation}
\label{sec:alg_vertexgen}
\input{chapters/adapt/adaptfun-vertexgen}


\subsection{Graph Edge and Weight Estimation}
...
\input{chapters/reachability/intro-motivation_and_overview}
...
%
\subsection{Main Steps of Path-sensitive Reachability-bound Analysis}
...
\subsection{Path-sensitive Reachability-bound Algorithm}
\label{sec:psRB-psrb}
\input{chapters/reachability/alg-psrb}

\subsection{Loop Bound and Local Path Reachability-bound Computation}
\label{sec:psRB-pathlocalrb}
\input{chapters/reachability/alg-pathlocalrb}

\subsection{Loop Reachability-bound Computation}
\label{sec:psRB-looprb}
\input{chapters/reachability/alg-looprb}

\subsection{Path Reachability-bound Computation}
