...
\title{
{A Program Analysis Framework for Adaptivity of Adaptive Data Analysis}, 
...
\chapter{Introduction\todo{rewrite}}
\label{introduction}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% INTRODUCTION %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\chapter{Introduction\todo{progress-90\% need passes on Details}}
...
\input{chapters/adapt/intro-motivation_and_overview}

\section{Chapter Outline}
\label{sec:adapt-outline}
\input{chapters/adapt/intro-outline}

\chapter{Previous Works on Adaptivity Analysis\todo{progress-80\% more simplifies and passes on details}}
\label{sec:prework}
...
\chapter{New Adaptivity Analysis Framework\todo{progress-70\% need emphasis on improvements and passes on details}}
\label{sec:adapt-analysis}
\input{chapters/adapt/analysis-preface}

% \section{Analysis Architecture}
% \label{ch:adapt-architecture}
% \include{chapters/adapt/analysis-architecture}
\clearpage
...
\input{chapters/adapt/static-adapt}
...
% \input{chapters/adapt/improved}
% \clearpage

\clearpage
\chapter{Examples and Implementations \todo{progress-60\% need update examples with new graph, emphasis on improvements and passes on details}}
...
\input{chapters/adapt/relatedwork-exe}
...
\input{chapters/adapt/relatedwork-adapt}
...
\chapter{Conclusion\todo{progress-30\% need details for Reachability bounds, emphasis on improvements of Adaptivity Analysis and passes on details}}
\label{sec:conclusion}
\input{chapters/conclusion}
\chapter{Future Works\todo{progress-70\% need simplifies and passes on details}}
\label{sec:future}
