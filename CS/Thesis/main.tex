...
\chapter{Introduction\todo{Prograss-(Reachability-10\%: more detail after PLDI), (Adapt-99\%: typos)}}
\label{introduction}
\input{chapters/intro-preface}


\section{Background and Motivation \todo{ ==> 98\%}}
\label{sec:intro-background}
\input{chapters/intro-background}


\section{Methodology Overview \todo{ ==> (Reachability-30\%: more detail after PLDI), (Adapt==>99\%: passes on details)}}
...
\chapter*{\redd{PART \romannum{1} \quad  REACHABILITY BOUND ANALYSIS} \todo{ ==> 10\%}}
...
\section{Adaptive Data Analysis\todo{==> 100\% passes on typos}}
\label{sec:adapt-background}
\input{chapters/adapt/intro-adaptive_data_analysis}

\section{Overview\todo{==> 100\% passes on typos}}
...
\chapter{Previous Works on Adaptivity Analysis\todo{==> 100\% passes on typos}}
\label{sec:prework}
...
\chapter{New Adaptivity Analysis Framework\todo{progress-99\% passes on details}}
...
% \input{chapters/adapt/static-improves}
...
\clearpage
\chapter{Example and Experimental Result \todo{==>100\% emphasis on improvements and passes on details}}
...
\chapter{Related Works\todo{progress-95\% need passes on details}}
