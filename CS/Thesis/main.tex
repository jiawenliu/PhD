...
\reader{Second}{Assaf Kfoury, Ph.D.}{Professor, Computer Science}
\reader{Third}{Alley Stoughton, Ph.D.}{Research Professor, Computer Science}
...
\subsection{Future Works on Accurate Adaptivity Analysis with Practical Application}
...
\subsection{Future Works on Accurate Reachability-bound Analysis}
...
\textbf{Summary}: & 
Reasoning about programs' execution properties has great potential in program optimization and program security. This dissertation exploits the program analysis to reason about \emph{quantitative-reachability} properties in different areas.
\\
\end{tabular}
