...
\clearpage
\chapter{Language Model -- {\tt QWhile}}
\label{sec:adapt-language}
\input{chapters/adapt/language}

\clearpage
\chapter{Adaptivity Formalization}
\label{sec:adapt-exe}
...
\chapter{Program Analysis for Adaptivity}
...
\begin{multicols}{1}{
\begin{center}{
665 Commonwealth Avenue, CDS 1002, \\ Boston University \\ Boston, MA 02118 \\
