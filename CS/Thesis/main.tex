...
\chapter{Previous Works on Adaptivity Analysis\todo{progress-85\% more simplifies and passes on details}}
\label{sec:prework}
...
\chapter{New Adaptivity Analysis Framework\todo{progress-90\% need emphasis on improvements and passes on details}}
