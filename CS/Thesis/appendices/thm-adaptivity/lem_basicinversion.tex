\begin{lem}[Expression Inversion]
	...
	$ \forall z^j \in \mathcal{LV}  \setminus \{x^i\} \sthat  
...
\begin{lem}[Expression Inversion Generalization]
	...
	\begin{itemize}
		...
		and for all $z^j \in \mathcal{LV}  \setminus (\mathcal{DF} \cup \{x^i\} )$ 
	...
	and for all
	$ z^j \in \mathcal{LV}  \setminus (\mathcal{DF} \cup \{x^i\} ) \sthat  
	 \exists \trace, \trace' \in \ftdom, v, v'\sthat  
	\env(\trace) z = \env(\trace') z \land 
