...
\begin{proof}
  ...
  \]
  By line:3 of $\pathsearch(\progG)$ algorithm defined in Algorithm~\ref{alg:adpt_alg}, let $\kw{\sccgraph_1}, \ldots, \kw{\sccgraph_n}$ be all the strong connected components on $\progG$ with $0 \leq n \leq |\vertxs|$,
...
$\visit(s) (s_1, \ldots, x)) \leq \kw{flowcapacity}(p_{x,x}^{i})$;
\\
