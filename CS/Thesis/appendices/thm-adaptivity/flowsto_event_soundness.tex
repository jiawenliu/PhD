...
For every $D \in \dbdom , c \in \cdom, \trace \in \ftdom \sthat  \forall \event_1, \event_2 \in \eventset \sthat 
\event_1, \event_2 \in \eventset^{\asn}$, 
if $\exists \trace' \in \ftdom \sthat  \trace = [\event_1] \tracecat \trace' \tracecat [\event_2]$ and 
$\eventdep(\event_1, \event_2, \trace, c, D) $, then
 $z_1^{r_1}, \ldots, z_n^{r_n} \in \lvar(c)$ with $n \geq 0$ such that   
...
\\
III. inductive case where $\trace = [\event_1, \ldots, \event_2]$.
\\
  ...
  \begin{case}($\trace = {[]}$)
    ...
    \begin{case}
      ...
      \begin{array}{l}
        ...
        \exists \trace' \in \ftdom \sthat  [\event_1'; \event_2'] = [\event_1] \tracecat \trace' \tracecat [\event_2]
        \\ \qquad 
            \implies    
     ...
     By Lemma~\ref{lem:flowsto_soundness_emptytrace}, we have this case proved.
      ...
      %
        %
        \begin{case}
        ($\event_1', \event_2' \in \eventset$, $\trace_{ih} \in \ftdom, \trace = [\event_1'] \tracecat \trace_{ih} \tracecat [\event_2'] \land \trace_{ih} \neq {[]}$)
        \\
