...
\[
  \begin{array}{l}
    ...
    \implies
		...
		\\ \quad 
		\implies 
    \exists n \in \mathbb{N}, z_1^{r_1}, \ldots, z_n^{r_n} \in \lvar_{{c}} \sthat 
    \\ \qquad 
     n \geq 0 \land
  ...
  \begin{case}($\trace = {[]}$)
    ...
    \begin{case}
      ...
      \begin{array}{l}
        ...
        \\ \qquad 
            \implies    
        % \forall  z^i, y^j \in \lvar_c, l_h, l_t \sthat  
      ...
      % since $\not\exists  z^i, y^j \in \lvar_c, l_h, l_t \sthat  l_h ++ [z^i, y^j] ++ l_t \in \{\}$, the theorem is vacuously true.
      % %
      % \\
      % Then in the case 1., 
     ...
     By Lemma~\ref{lem:flowsto_soundness_emptytrace}, we have this case proved.
      ...
      %
        ...
        \[    \begin{array}{l}
         \forall \event_1, \event_2 \in \eventset \sthat 
          ...
          \\ \quad 
          \implies 
          \exists n \in \mathbb{N}, z_1^{r_1}, \ldots, z_n^{r_n} \in \lvar_{{c}} \sthat  n \geq 0 
          \\ \quad  
          \land
          \flowsto(\pi_1(\event_1)^{\pi_2(\event_1)},  z_1^{r_1}, c) 
          \land \ldots \land \flowsto(z_n^{r_n}, \pi_1(\event_2)^{\pi_2(\event_2)}, c) 
        ...
        \[
          \begin{array}{l}
            ...
            \\ \quad 
            \implies 
            \exists n \in \mathbb{N}, z_1^{r_1}, \ldots, z_n^{r_n} \in \lvar_{{c}} \sthat  n \geq 0 \land
      ...
      \]
        ...
        \[
          \begin{array}{l}
            \exists n \in \mathbb{N}, z_1^{r_1}, \ldots, z_n^{r_n} \in \lvar_{{c}} 
            \sthat  n \geq 0 
            \\ \quad  \land
            \flowsto(\pi_1(\event_1)^{\pi_2(\event_1)},  z_1^{r_1}, c) 
