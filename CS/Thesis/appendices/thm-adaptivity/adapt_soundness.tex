...
\begin{lem}[Weights are bounded]
	...
	\[
		\begin{array}{l}
			...
			(x^l, w_{p}) \in \progW, \vtrace, \trace' \in \ftdom, v \in \mathbb{N} \sthat 
...
$(x^l, w_{t}) \in \traceW, (x^l, w_{p}) \in \progW, \vtrace, \trace' \in \ftdom$, satisfying:
\\
