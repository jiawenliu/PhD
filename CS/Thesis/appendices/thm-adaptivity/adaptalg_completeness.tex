...
\begin{proof}
  ...
  \[
    \qlen(k_{max}) = \len(s | s \in (s_1, \ldots, s_n) \land \progF(s) = 1) = \pathsearch(\progG(c))
  \]
  ...
  \[
    \qlen(k_{max}) = \sum_{s_i \in (s_1, \ldots, s_n)} \progF(s_i)
  \]
  %
  ...
  \[
    \sum_{\sccgraph_i \in (\sccgraph_1, \ldots, \sccgraph_m)} \kw{adapt_{scc}[\sccgraph_i]} = 
    \sum_{\sccgraph_i \in (\sccgraph_1, \ldots, \sccgraph_n)} \progF(s_i)
    = \sum_{s_i \in (s_1, \ldots, s_n)} \progF(s_i).
  \]
