\begin{subproof}[Proof of the Basecase of Control Dependency]
%
\label{pf:eventdep_base_ctl}
By definition $\eventdep(\event_1, \event_2, [\event_1; \event_2], c, D)$ of case 2, we know
\begin{equation}
...
\[
  x_1 \in \kw{FV}(b)  \land x_1^{l_1} \in \live(l_b, c)
\]
%
