...
\[
	...
	\]
%
In case of $ \pi_1(\event_z) \notin \kw{FV}(\expr_2 / \qexpr_2)$, by Inversion Lemma~\ref{lem:inv_expr}
...
\[
	\begin{array}{l}
		...
		\\ \qquad 
		\Big( \forall z^j \in \mathcal{LV} / \{\pi_1(\event_z)^{\pi_2(\event_z)} \} \sthat  
		\\ \qquad 
