...
% or 
there exist $z_1^{r_1}, \ldots, z_n^{r_n} \in \lvar_{{c}}$ with $n \geq 0$ such that   
...
\begin{array}{l}
  ...
  \vardep(x^i, y^j, {c})
  \\ \quad \implies
  \Big( \exists n \in \mathbb{N}, z_1^{r_1}, \ldots, z_n^{r_n} \in \lvar_{{c}} \sthat  n \geq 0 \land
  \flowsto(x^i,  z_1^{r_1}, c) 
...
For  arbitrary two $x^i, y^j \in \lvar_c$, with \emph{Variable May-Dependency} relation, in order to show there exists a 
