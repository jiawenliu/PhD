...
% We omitted the estimated graph, which is identical to the graph in Figure~\ref{fig:multipleRoundsOdd_example}(b). 
%
...
(c) The program-based dependency graph graph from $\THESYSTEM$.}
    \label{fig:multipleRoundsOdd_example}
    % \vspace{-0.5cm}
\end{figure}
}
%
