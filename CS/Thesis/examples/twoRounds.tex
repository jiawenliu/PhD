...
\draw[ thick, -Straight Barb] (1.5, 3.5) arc (120:-200:1);
    % The Weight for this edge
    \draw[](3, 3) node [] {\highlight{\footnotesize $\trace_0 \to \env(\trace_0) k  $}};
...
% The Weight for this edge
node [] {\highlight{\footnotesize $\trace_0 \to \env(\trace_0) k $}} (4, 9) ;
...
\begin{subfigure}{.4\textwidth}
    ...
    \draw[ ultra thick, -latex, densely dotted,] (0, 1.5)  -- 
    % The Weight for this edge
    node [left] {\highlight{$1$}}(0, 3.5) ;
    \draw[ ultra thick, -latex, densely dotted,] (0, 4.5)  -- 
    node [left] {\highlight{$ k $}}(0, 6.5) ;
    \draw[ thick, -latex] (0, 4.5)  to  [out=-230,in=230]  
    node [left] {\highlight{$ k $}}(0, 9.5) ;
    \draw[ thick, -Straight Barb] (1.5, 3.5) arc (120:-200:1);
        % The Weight for this edge
        \draw[](3, 3) node [] {\highlight{$ k  $}};
    \draw[ thick, -Straight Barb] (6.5, 6.5) arc (150:-150:1);
        % The Weight for this edge
        \draw[](9, 6) node [] {\highlight{$ k  $}};
    \draw[ thick, -latex] (5, 6.5)  -- 
    % The Weight for this edge
    node [right] {\highlight{$ k $}} (5, 8.5) ;
    % Control Dependency
    \draw[ thick,-latex] (1.5, 7)  -- (4, 9) ;
    \draw[ thick,-latex] (1.5, 4)  -- 
    % The Weight for this edge
    node [] {\highlight{$ k $}} (4, 9) ;
    \draw[ thick,-latex] (1.5, 7)  -- (4, 6) ;
    \draw[ thick,-latex] (1.5, 4)  -- (4, 6) ;
    \end{tikzpicture}
    \caption{}
...
(c) The corresponding program-based dependency graph.}
