...
\newcommand{\todo}[1]{\textcolor[rgb]{1,0.0,0}{\textbf{[[ #1 ]]}}}
\newcommand{\redd}[1]{\textbf{\textcolor[rgb]{0,0.0,0}{#1 }}}
...
\newcommand{\mmin}{\ensuremath{\mathsf{min}}}
...
\newcommand{\cfgG}{\kw{{G_{cfg}}}}
\newcommand{\cfgV}{\kw{{V_{cfg}}}}
\newcommand{\cfgE}{\kw{{E_{cfg}}}}
\newcommand{\cfginit}{{\kw{init}}}
\newcommand{\cfgfinal}{{\kw{final}}}
\newcommand{\cfgflow}{{\kw{cfgflow}}}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Non-Monotonic Quantitative Property Analysis %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newcommand{\alloc}{\kw{incr}}
\newcommand{\release}{\kw{dec}}
\newcommand{\traceOP}{\kw{opQ_{trace}}}
\newcommand{\traceNMG}{\kw{nmG_{trace}}}
\newcommand{\traceNMV}{\kw{nmV_{trace}}}
\newcommand{\traceNME}{\kw{nmE_{trace}}}
\newcommand{\allocvar}{\mathbb{incrV}}
\newcommand{\releasevar}{\mathbb{decV}}
\newcommand{\NMlen}{\kw{nmlen}}
...
\newcommand{\loopl}{\progl_{\kw{loop}}}
\newcommand{\tracel}{\progl_\kw{{trace}}}
\newcommand{\pathl}{\progl_\kw{path}}
